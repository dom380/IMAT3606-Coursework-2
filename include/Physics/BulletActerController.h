...
//--------------------------------------------------------------------------
//	**NOTE**
//	This is a re-implementation of the btKinematicCharacterController
//	with the addition of dynamic object collision and better integration
//	into this engine.					
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
...
#pragma once
#ifndef BULLETACTORCONTROLLER_H
#define BULLETACTORCONTROLLER_H
...
public:
	...
	BulletActerController(btPairCachingGhostObject* ghostObject, btConvexShape* convexShape, btScalar stepHeight, const btVector3& up = btVector3(1.0, 0.0, 0.0));
	~BulletActerController();
