...
{
private:
	//update existing logic comp of element in xmlfile
	...
	//update existing trigger of element in xmlfile
	static bool UpdateTrigger(tinyxml2::XMLDocument* doc, tinyxml2::XMLElement* ele, CollisionTrigger* triggerComp);
	...
	//Add trigger comp to element in xmlfile
	static bool AddTrigger(tinyxml2::XMLDocument* doc, tinyxml2::XMLElement* ele, CollisionTrigger* triggerComp);
	//add vec3 
