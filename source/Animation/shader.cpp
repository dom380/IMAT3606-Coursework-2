...
void Shader::compileShader(const char* fileName) throw(ShaderException) 
{
...
void Shader::compileShader(const char* fileName, GLSLShader::GLSLShaderType type) throw(ShaderException)
{
...
void Shader::compileShader(const std::string& source, GLSLShader::GLSLShaderType type, const char* fileName) throw(ShaderException)
{
  if(handle <= 0) 
  {
    handle = glCreateProgram();
