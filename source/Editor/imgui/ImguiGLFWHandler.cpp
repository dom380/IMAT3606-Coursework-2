...
const char * ImguiGLFWHandler::GetClipboardText(void * user_data)
{
	return glfwGetClipboardString((GLFWwindow*)user_data);
}

void ImguiGLFWHandler::SetClipboardText(void * user_data, const char * text)
{
...
void ImguiGLFWHandler::shutdown()
{
	invalidateDeviceObjects();
	ImGui::Shutdown();
}

void ImguiGLFWHandler::newFrame()
{
	if (!g_FontTexture)
		createDeviceObjects();
...
void ImguiGLFWHandler::invalidateDeviceObjects()
{
...
bool ImguiGLFWHandler::createDeviceObjects()
{
	// Backup GL state
...
bool ImguiGLFWHandler::createFontsTexture()
{
	// Build texture atlas
	ImGuiIO& io = ImGui::GetIO();
