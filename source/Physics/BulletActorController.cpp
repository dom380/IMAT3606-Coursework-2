...
public:
	...
	{
		if (rayResult.m_collisionObject == m_me || !rayResult.m_collisionObject->hasContactResponse())
			return 1.0;
...
*/
btVector3 BulletActerController::computeReflectionDirection(const btVector3& direction, const btVector3& normal)
{
...
*/
btVector3 BulletActerController::parallelComponent(const btVector3& direction, const btVector3& normal)
{
...
*/
btVector3 BulletActerController::perpindicularComponent(const btVector3& direction, const btVector3& normal)
{
	return direction - parallelComponent(direction, normal);
}

BulletActerController::BulletActerController(btPairCachingGhostObject* ghostObject, btConvexShape* convexShape, btScalar stepHeight, const btVector3& up)
{
...
BulletActerController::~BulletActerController()
{
}

btPairCachingGhostObject* BulletActerController::getGhostObject()
{
	return m_ghostObject;
}

bool BulletActerController::recoverFromPenetration(btCollisionWorld* collisionWorld)
{
...
void BulletActerController::stepUp(btCollisionWorld* world)
{
...
bool BulletActerController::needsCollision(const btCollisionObject* body0, const btCollisionObject* body1)
{
...
void BulletActerController::updateTargetPositionBasedOnCollision(const btVector3& hitNormal, btScalar tangentMag, btScalar normalMag)
{
...
void BulletActerController::stepForwardAndStrafe(btCollisionWorld* collisionWorld, const btVector3& walkMove)
{
...
void BulletActerController::stepDown(btCollisionWorld* collisionWorld, btScalar dt)
{
...
void BulletActerController::setWalkDirection
(
...
void BulletActerController::setVelocityForTimeInterval
(
...
void BulletActerController::setAngularVelocity(const btVector3& velocity)
{
	m_AngVel = velocity;
}

const btVector3& BulletActerController::getAngularVelocity() const
{
	return m_AngVel;
}

void BulletActerController::setLinearVelocity(const btVector3& velocity)
{
	m_walkDirection = velocity;
...
btVector3 BulletActerController::getLinearVelocity() const
{
	return m_walkDirection + (m_verticalVelocity * m_up);
}

void BulletActerController::reset(btCollisionWorld* collisionWorld)
{
	m_verticalVelocity = 0.0;
	m_verticalOffset = 0.0;
	m_wasOnGround = false;
...
void BulletActerController::warp(const btVector3& origin)
{
	btTransform xform;
	xform.setIdentity();
...
void BulletActerController::preStep(btCollisionWorld* collisionWorld)
{
	m_currentPosition = m_ghostObject->getWorldTransform().getOrigin();
	m_targetPosition = m_currentPosition;
...
void BulletActerController::playerStep(btCollisionWorld* collisionWorld, btScalar dt)
{
	//	printf("playerStep(): ");
	//	printf("  dt = %f", dt);
...
void BulletActerController::setFallSpeed(btScalar fallSpeed)
{
	m_fallSpeed = fallSpeed;
}

void BulletActerController::setJumpSpeed(btScalar jumpSpeed)
{
	m_jumpSpeed = jumpSpeed;
	m_SetjumpSpeed = m_jumpSpeed;
}

void BulletActerController::setMaxJumpHeight(btScalar maxJumpHeight)
{
	m_maxJumpHeight = maxJumpHeight;
}

bool BulletActerController::canJump() const
{
	return onGround();
}

void BulletActerController::setJumpRayOffset(float offset)
{
...
void BulletActerController::setGravity(const btVector3& gravity)
{
...
btVector3 BulletActerController::getGravity() const
{
	return -m_gravity * m_up;
}

void BulletActerController::setMaxSlope(btScalar slopeRadians)
{
	m_maxSlopeRadians = slopeRadians;
	m_maxSlopeCosine = btCos(slopeRadians);
}

btScalar BulletActerController::getMaxSlope() const
{
	return m_maxSlopeRadians;
}

void BulletActerController::setMaxPenetrationDepth(btScalar d)
{
	m_maxPenetrationDepth = d;
}

btScalar BulletActerController::getMaxPenetrationDepth() const
{
...
btVector3* BulletActerController::getUpAxisDirections()
{
...
void BulletActerController::debugDraw(btIDebugDraw* debugDrawer)
{
}

void BulletActerController::setUpInterpolate(bool value)
{
	m_interpolateUp = value;
}

void BulletActerController::setUp(const btVector3& up)
{
...
void BulletActerController::setJumpRay(float ray)
{
	m_jumpRay = ray;
}

void BulletActerController::setUpVector(const btVector3& up)
{
	if (m_up == up)
		return;
...
btQuaternion BulletActerController::getRotation(btVector3& v0, btVector3& v1) const
{
